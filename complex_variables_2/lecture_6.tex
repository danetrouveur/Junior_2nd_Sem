...
\leq & \dfrac{1}{r}
\end{align*}\]
if $|z|<r<1$. Taking $r\rightarrow 1^{-}$, $|f(z)/z|\leq 1$. That is, $|f(z)|\leq |z|$ for all $z\in U$. Also, $f'(z)=g(z)+zg'(z)$ which implies that $f'(0)=g(0)$. This again implies that $|f'(0)|=|g(0)|\leq 1$. 
