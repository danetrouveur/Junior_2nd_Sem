...
\end{cases}\]
\section{Gauged Four Charge Ansatz Construction}
...
\[\begin{align*}
ds^2=\dfrac{W}{r^2+a^2\cos ^2\theta }\bigg[&-\dfrac{(1+g^2r^2)(1-a^2g^2\cos ^2\theta )}{1-a^2g^2}\,dt^2+(r^2+a^2\cos ^2\theta )\Big(\dfrac{dr^2}{\mathrm{\Delta}}+\dfrac{d\theta ^2}{1-a^2g^2\cos ^2\theta }\Big)\\&+\dfrac{r^2+a^2}{1-a^2g^2}\sin ^2\theta \,d\phi ^2+\dfrac{W^2}{2m}\Big(\sum ^{4}
...
\[\begin{align*}
\dfrac{W^2}{2m}A_{i}=&K_1\Big(\dfrac{r_1r_2r_3r_4}{r_{i}}+2ma^2\cos ^2\theta \dfrac{e_{i}}{c_{i}s_{i}}+ra^2\cos ^2\theta \Big)\\&\times \Big[K_2\,c_{i}s_{i}\,dt-K_3\,a\sin^2 \theta \Big(\dfrac{c_1c_2c_3c_4s_{i}}{c_{i}}-\dfrac{s_1s_2s_3s_4c_{i}}{s_{i}}\Big)\,d\phi\Big]\\ &+K_4\,2ma^2\cos ^2\theta \Big(\dfrac{c_1c_2c_3c_4}{c_{i}^2}(e_{i}-c_{i}s_{i})-\dfrac{s_1s_2s_3s_4}{s_{i}^2}(e_{i}-c_{i}s_{i})\Big)a\sin ^2\theta \,d\phi 
\end{align*}\]
Notice that we have a total of 5 undetermined elements, namely $(\mathrm{\Delta },K_1,K_2,K_3,K_4)$. We suggest the following methods for the determination process:
\begin{itemize}
